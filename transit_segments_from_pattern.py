...
fin_transitseg = arcpy.CreateFeatureclass_management(geodb,"transitsegs_test02","POLYLINE",spatial_reference = 4269)
fin_transitseg = r'G:\01_Projects\TransitServicePlanning\CorridorSpeedAnalysis\01_Geodata\Working\TransitSegment_Generation.gdb\transitsegs_test02'
